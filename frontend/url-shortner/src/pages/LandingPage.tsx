...
const LandingPage = () => {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#07101d] px-5 py-5 text-[#eef6ff] sm:px-7 lg:px-12 xl:px-20 xl:py-7">
      ...
      <section className="relative z-10 mx-auto mt-16 flex min-h-[520px] max-w-[950px] flex-col items-center text-center sm:mt-20 lg:mt-10 xl:mt-28 xl:min-h-[590px]" id="shorten">
        <div className="inline-flex min-h-8 animate-[fadeUp_650ms_ease-out_100ms_both] items-center gap-3 rounded-full border border-white/10 bg-[#0b1221]/55 px-4 text-sm font-semibold text-[#a8b2c8] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:text-base">
        ...
        <h1 className="mt-6 max-w-[760px] animate-[fadeUp_700ms_ease-out_190ms_both] text-[46px] font-black leading-[1.02] tracking-normal text-white sm:text-[62px] lg:mt-4 lg:text-[70px] xl:text-[88px]">
          Tiny links.
        ...
        <form className={`mt-9 w-full max-w-[900px] animate-[fadeUp_700ms_ease-out_370ms_both] rounded-[30px] border border-[#08dcc3]/45 bg-[#08101e]/80 p-4 text-left shadow-[0_0_52px_rgba(5,218,193,0.2),0_40px_90px_rgba(0,0,0,0.32)] backdrop-blur-xl transition-all duration-500 hover:border-[#08dcc3]/70 hover:shadow-[0_0_70px_rgba(5,218,193,0.25),0_40px_90px_rgba(0,0,0,0.32)] sm:p-5 lg:mt-8 lg:rounded-[34px] ${(isCustom || isProtected) ? "max-w-[940px]" : ""}`}
            onSubmit={handleShortening}
          >
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_auto]">
            <label className="sr-only" htmlFor="long-url">Paste your long URL</label>
            <div className="flex min-h-14 min-w-0 items-center gap-3 rounded-[22px] bg-[#22233d]/75 px-4 text-[#9ca7bd] transition duration-300 focus-within:bg-[#272943]/90 focus-within:ring-1 focus-within:ring-[#08dcc3]/40 lg:min-h-16 lg:gap-4 lg:rounded-[26px] lg:px-5">
            ...
            <button className="flex min-h-14 items-center justify-center gap-3 rounded-[22px] bg-[linear-gradient(135deg,#04e1c0,#09d3b7)] px-7 text-base font-extrabold text-[#02151a] shadow-[0_20px_55px_rgba(5,218,193,0.24)] transition hover:-translate-y-0.5 hover:shadow-[0_26px_70px_rgba(5,218,193,0.32)] disabled:cursor-wait disabled:opacity-75 sm:text-lg lg:min-h-16 lg:rounded-[26px] lg:px-8 lg:text-xl" type="submit" disabled={isLoading}>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <button
              className={`group flex min-h-11 items-center gap-2 rounded-full border px-4 text-sm font-extrabold transition-all duration-300 sm:text-base ${isCustom ? "border-[#08dcc3] bg-[#08dcc3]/10 text-white shadow-[0_0_28px_rgba(8,220,195,0.18)]" : "border-white/5 bg-[#0b1221]/75 text-[#9aa6ba] hover:border-[#08dcc3]/35 hover:text-white"}`}
              type="button"
              onClick={() => {
            ...
            <button
              className={`group flex min-h-11 items-center gap-2 rounded-full border px-4 text-sm font-extrabold transition-all duration-300 sm:text-base ${isProtected ? "border-[#cf69ff] bg-[#cf69ff]/14 text-white shadow-[0_0_28px_rgba(207,105,255,0.18)]" : "border-white/5 bg-[#17152b]/75 text-[#9aa6ba] hover:border-[#cf69ff]/35 hover:text-white"}`}
              type="button"
              onClick={() => {
            ...
            <div className="mt-5 grid gap-5 animate-[fadeUp_360ms_ease-out_both]">
              ...
              {isProtected && (
                <div className="grid gap-3 animate-[fadeUp_360ms_ease-out_both]">
                  ...
                  <div className="flex min-h-14 items-center gap-3 rounded-[22px] bg-[#22233d]/75 px-5 text-[#9ca7bd] transition duration-300 focus-within:bg-[#272943]/90 focus-within:ring-1 focus-within:ring-[#cf69ff]/40">
                    ...
                    <input
                      ...
                      placeholder="Visitors will need this to open the link"
                      value={password}
